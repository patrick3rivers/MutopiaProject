...
\finaleFirstBar  
  ...
  | f'4\F c8 a'
  %% 81
  | f4 r | d\F a8 _[ f' ] | d4 r | bes4 f8 d'
  %% 85
  ...
  | bes,2\dolce ( | a | g | f
  %% 145
  | ees2 | d4 c ) | bes8 _[ ( c d ees ] ) | f4 r
  %% 149
  | r4 bes ( | a aes | g ges | f f 
  %% 153
  | e4\Cresc ees )
  | d4 ees | f\F f, | bes8 [ f' bes d ]
  | c ( ees ) r ees
  %% 157
  | d8 [ c bes a ]
  | bes [ f bes d ]
  ...
  | c16 d ees f g f g a
  | bes8 d,16 c ees _[ d c bes ]
  | a _[ bes c d ] ees f ees c
  %% 165
  | d4 r8 a' | bes8 [ a bes a ] | bes4 r8 c, | d [ c d c ]
  %% 169
  | d8 [ bes' f d ] | bes4 r \bar ":|.|:" s32
}
