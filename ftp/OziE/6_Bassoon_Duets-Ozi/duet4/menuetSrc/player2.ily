...
part = \relative c' {
  ...
  \relative c {
    | f,4\P r f'
    \once \override Beam.auto-knee-gap = #0.5
    | e8 c d e f f,
    | bes4 r bes
    | c8 \bmOn c, \bmOff f a c f
    ...
    \tempo "mineur"
    \clef bass
    \override Staff.KeySignature.flat-positions = #'(4)
    \override Staff.KeyCancellation.flat-positions = #'(4)
    \key f \minor
    \time 3/4
    \override Beam.auto-knee-gap = #1.5
    ...
    | \tuplet 3/2 { c8\F e f g a b }  c8 r \tweak self-alignment-X #CENTER \textEndMark \markup \fermata 
     \bar ":|.|:"
