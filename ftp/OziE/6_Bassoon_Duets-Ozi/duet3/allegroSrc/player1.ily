...
part = \relative c'' {
  ...
  | f4. e8 d c
  | c4 ( bes8 ) g bes d
  | cis4 e8 \cAccOn cis \cAccOff a g
  | g4 ( f8 ) a b cis
  %% 05
  | d8 cis d f, g a
  | bes8 a bes e, f g
  ...
  | g,2\dolce <<
    ...
    \\
    \new Voice {
      \voiceOne s8. \cadenzaOn \grace { g16 a } \cadenzaOff } s16
  >>
  | bes2. ~
  | bes8 bes c bes a g
  %% 93
  ...
  <<
    { g4\tr }
    \\
    { \voiceOne s8. \cadenzaOn \grace { fis16 g } \cadenzaOff } s16
    >>
  | a4. a8 g fis
  | g4 r g
  %% 97
