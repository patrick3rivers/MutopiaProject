...
\header {
  ...
  copyright = \markup \center-column {
    \line { Public Domain.}
    \line {
      Edited and Engraved by Patrick Paulson (patrick_paulson@3rivers-ashtanga.org)
    }
  }
...
scorePart = \markup "Second Player"
  ...
  \center-column {
    ...
    \column {
      ...
      \wordwrap {
        ...
        (\musicglyph #"scripts.ustaccatissimo") are replaced with staccato
        throughout, unless noted, since all pieces contain either only staccatto
        or staccatissimo articulations, never both. Changed accidentals
    ...
    \column {
      ...
      \vspace #1
      \wordwrap {
        { \italic M. 21, Player one.} Source has an incomplete measure, added
        an eighth note of rest.
      }
      \vspace #1
      \wordwrap {
        { \italic M. 69. Player one.} Mashed together pickup to piece and last measure of first section.
      }
      \vspace #1
      \wordwrap {
        { \italic M. 89. Player one.} Source has an incomplete measure, added quarter note rest.
      }
      \vspace #2
      \wordwrap {
        { \italic Menueto.}
