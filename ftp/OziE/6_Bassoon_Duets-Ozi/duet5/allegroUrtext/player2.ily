...
part = \relative c' {
  ...
  \repeat volta 2 {
    ...
    | \repeat tremolo4 f8 \repeat tremolo4 f8
    | e4 r c e | f r d f | g8 g fis g g,2 ~ | g1
    | g4 r b r | c'2\F e4.  d8 | \grace e8 d8 c c4 r8 c e c
    | g4 d'4 ~ d8 d e f
    | f2 e4 r
    | a,2 d8 c b a | \grace a8 g4 c8 d e d c b | a8 cis d cis
     \tupletUp \tuplet 3/2 4 { d8 e d c b c } \tupletNeutral
     | c2 b4 r
    | R1*1
    | c4.\F a8 fis d e fis
    | g4 r r2
    ...
    | g,4 r \tuplet 3/2 4 {
      ...
      | c8 a b c\prall b c a b [ ( c ] ) g b [ ( c ] )
