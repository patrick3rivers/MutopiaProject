...
part = \relative c' {
  ...
  \repeat volta 2 {
    ...
    | \tuplet 3/2 { g8 b d g d b } g4 \cadenzaOn r4 \cadenzaOff
    \tuplet 3/2 { g'8 [ a b ] }
    | a4\st r a,\st g\st
    | fis4\st r fis\st e\st
    | d4 r fis f'
    | g4 r \repeat tremolo 4 d8\P
  ...
  | g4. a8 b4 b8 a
  %% 065
  | \grace a8 g4 g4. b8 c b
  | \grace b8 a4 a4. cis8 d c
  | b8 a g fis e d c b
  ...
  | c8\st [ e\st] c\st r c\st [ e\st ] c\st r
  | d8 [ \cAccOn f ] \cAccOff \cadenzaOn d4 \cadenzaOff s8 r d f d c
  | b4 c d dis
  ...
  | c4.\dolce d16 c b4 a
  | b8 c cis d d4 r
  | d4. \cadenzaOn e8 d \cadenzaOff s8 c4 b
  | c8 d dis e e e, f g
  | a2. g4
  | fis2 f2
